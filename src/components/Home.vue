    ...
    <v-container>
        ...
        <v-layout row wrap class="mt-3">
            <v-flex xs12 sm6 class="text-sm-right text-xs-center">
                <v-btn large to="/meetups" color="red darken-3 white--text">Explore Meetups</v-btn>
            </v-flex>
            <v-flex xs12 sm6 class="text-sm-left text-xs-center">
                <v-btn large to="/meetups/new" color="red darken-3 white--text">Organize Meetup</v-btn>
            </v-flex>
        </v-layout>
        <v-layout row wrap class="mt-3">
